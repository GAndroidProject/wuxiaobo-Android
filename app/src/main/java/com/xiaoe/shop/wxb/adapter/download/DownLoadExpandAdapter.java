 ...
 * @date: 2018/12/24
 */
public class DownLoadExpandAdapter extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {
     ...
     */
    public DownLoadExpandAdapter(Context context, List<MultiItemEntity> data) {
        super(data);
        this.mContext = context;
        addItemType(SINGLE_ITEM, R.layout.download_single);
