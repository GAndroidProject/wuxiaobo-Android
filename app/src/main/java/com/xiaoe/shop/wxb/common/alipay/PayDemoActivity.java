package com.xiaoe.shop.wxb.common.alipay;
...
public class PayDemoActivity extends AppCompatActivity {
     ...
     * 用于支付宝支付业务的入参 app_id。
     */
    public static final String APPID = "2019010862855483";
