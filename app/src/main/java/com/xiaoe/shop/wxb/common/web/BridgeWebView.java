...
import com.xiaoe.shop.wxb.BuildConfig;
...
//        setting.setAllowFileAccessFromFileURLs(true);
        ...
        setting.setUserAgentString(ua + ":telebox");
    ...
    @JavascriptInterface
    public boolean shareCandyUrl(String title, String url) {
        ToastUtils.show(getContext(), "Title:" + title + " Url:" + url);

//        ShareInfo shareInfo = new ShareInfo();
//        shareInfo.setTitle(title);
//        shareInfo.setUrl(url);
//        ShareManager.getInstance().openShareBoard(getContext(), StyleUtil.WEB10, shareInfo);
        return true;
    }
