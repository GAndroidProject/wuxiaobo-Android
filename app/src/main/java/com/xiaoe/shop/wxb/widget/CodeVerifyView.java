...
public class CodeVerifyView extends LinearLayout implements TextWatcher, View.OnKeyListener, View.OnFocusChangeListener {
    ...
    public void setmEtHiehgt(int mEtHeight) {
    ...
    public CodeVerifyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        @SuppressLint({"Recycle", "CustomViewStyleable"})
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CodeVerifyView);
        mEtNumber = typedArray.getInteger(R.styleable.CodeVerifyView_cv_number, 4);
        int inputType = typedArray.getInt(R.styleable.CodeVerifyView_cv_inputType, VCInputType.NUMBER.ordinal());
        mEtInputType = VCInputType.values()[inputType];
        mEtWidth = typedArray.getDimensionPixelSize(R.styleable.CodeVerifyView_cv_width, 120);
    ...
    private void initEditText(EditText editText, int i) {
        int childHPadding = Dp2Px2SpUtil.dp2px(mContext, 20);
...
//        layoutParams.rightMargin = 0;
        ...
        layoutParams.setMargins(childHPadding,0,childHPadding,0);
...
//        editText.setMaxEms(1);
        ...
        int padding = Dp2Px2SpUtil.dp2px(mContext, 6);
