...
public class PageFragmentPresenter implements IBizCallback {
     ...
     */
    public void requestMicroPageData(LoginUserInfo loginUserInfo, String microPageId) {
        // appiOW1KfWe9943 u_5bd995b7db6ac_65ACBvuFTU -- 暂时测信息流
        // apppcHqlTPT3482 u_5ad010f47073c_yeHaGL9bEG -- 主干数据
        if (loginUserInfo.getUserId().equals("") || loginUserInfo.getShopId().equals("")) {
            // 登录用户信息为空
        ...
        pageFragmentRequest.addRequestParam("user_id", loginUserInfo.getUserId());
        pageFragmentRequest.addRequestParam("shop_id", loginUserInfo.getShopId());
